    ...
    onStart: async function ({ api, event }) {
        ...
        try {
            api.getUserInfo(targetID, async (err, obj) => {
                ...
                // ক্যানভাসের জন্য ইউনিভার্সাল ফন্ট ডাউনলোড ও রেজিস্টার
                const fontPath = path.join(cacheDir, "NotoSans-Regular.ttf");
                ...
                // ক্যানভাসে কাস্টম ফন্ট ফ্যামিলি ব্যবহার করা
                ctx.font = "bold 24px 'CanvasFont', Arial";
